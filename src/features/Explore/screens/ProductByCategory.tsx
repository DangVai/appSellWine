...
// Định nghĩa kiểu navigation và route cho stack
...
export default function ProductsByCategoryScreen() {
    ...
    // 1. Fetch Categories khi component mount
    useEffect(() => {
    ...
    // 2. Fetch Products khi selectedCategoryId thay đổi
    useEffect(() => {
        ...
        // Animation khi products thay đổi
    ...
    // Reset animation khi products thay đổi
    useEffect(() => {
        fadeAnim.setValue(0);
        Animated.timing(fadeAnim, {
            toValue: 1,
    ...
    const handleCategorySelect = (categoryId: number | null) => {
        ...
        setShowFilter(false); // Đóng modal sau khi chọn
    };
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Product Counter và Filter Button */}
